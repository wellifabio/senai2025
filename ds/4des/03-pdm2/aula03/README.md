...
- Abase de dados para as perguntas deve estar em um arquivo `assets/mockups/questoes.ts` semelhante ao arquivo a seguir, você não deve utilzar estas questões, é somente um **exemplo**:
```ts
